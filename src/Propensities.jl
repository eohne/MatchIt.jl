...
"""
    get_propensities(data::DataFrame,f::FormulaTerm,link::GLM.Link01)
...
# Arguments:
  ...
  * f`::FormulaTerm`: A formula specifying the functional form of the regression (use `@formual` to create it)
